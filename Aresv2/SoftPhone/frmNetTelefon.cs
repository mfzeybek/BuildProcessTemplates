...
{
	public partial class frmNetTelefon : DevExpress.XtraEditors.XtraForm
	{
		public frmNetTelefon(string TelefonNo)
		{
			InitializeComponent();
		...
		private void frmNetTelefon_Load(object sender, EventArgs e)
		{
			InitializeSoftPhone();
			buttonPickUp_Click(null, null);
		}
	}
}