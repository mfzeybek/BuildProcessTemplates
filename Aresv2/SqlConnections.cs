...
namespace Aresv2
{
  public class SqlConnections : IDisposable
  {
    ...
    Aresv2.Properties.Settings set = new Properties.Settings();

    public SqlConnections()
    {
      _ConStr = Aresv2.Properties.Settings.Default.DBConStr; // Programın propertisinden okunanacak connection string değeri
    }
