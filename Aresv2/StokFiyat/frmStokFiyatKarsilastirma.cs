...
namespace Aresv2.Stok
{
    public partial class frmStokFiyatKarsilastirma : DevExpress.XtraEditors.XtraForm
    {
        ...
        {
            if (Convert.ToDecimal(txtYuvarla.EditValue) != 0)
            {
                for (int i = 0; i < gridView1.RowCount; i++)
                {
                    decimal rakkamhamisina = Yuvarlama(Convert.ToDecimal(gridView1.GetRowCellValue(i, colFiyat2)), YuvarlamaSekli.Yukari, Convert.ToDecimal(txtYuvarla.EditValue));
        ...
        private void btnAsagiYuvarla_Click(object sender, EventArgs e)
        {
            for (int i = 0; i < gridView1.RowCount; i++)
            {
                decimal YuvarlanmisSayi = Yuvarlama(Convert.ToDecimal(gridView1.GetRowCellValue(i, colFiyat2)), YuvarlamaSekli.Asagi, Convert.ToDecimal(txtYuvarla.EditValue));
        ...
        private void frmStokFiyatKarsilastirmalayoutControl1ConvertedLayout_Click(object sender, EventArgs e)
        {
