...
namespace clsTablolar
{
    public class csFiyatTanim : IDisposable
    {
        ...
        public DataTable TumFiyatTanimlariniGetir(SqlConnection Baglanti, SqlTransaction Tr, bool CustomFiyatGelsinMi)
        {
            using (da_ButunFiyatTanimlari = new SqlDataAdapter())
            {
                ...
                dt_ButunFiyatTanimlari.Rows.Add(dt_ButunFiyatTanimlari.NewRow());
                if (CustomFiyatGelsinMi == true)
                {
                    dt_ButunFiyatTanimlari.Rows[dt_ButunFiyatTanimlari.Rows.Count - 1]["FiyatTanimID"] = -2;
                    dt_ButunFiyatTanimlari.Rows[dt_ButunFiyatTanimlari.Rows.Count - 1]["FiyatTanimAdi"] = "Custom";
                    dt_ButunFiyatTanimlari.Rows[dt_ButunFiyatTanimlari.Rows.Count - 1]["AlisMiSatisMi"] = "HiçbiriAmk";
                }
